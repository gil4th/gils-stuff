...
while choice_1 != "quit":
   print("hey this program will take your age and when you plan to have kids (or when you did) and making some assumptions like the average age people have kids and tell you at what year a generation of your choice will be born. Or you can also enter a year and it will compute how many decedents you are going to have by then")
   ...
   year_born = input()
   year_born = int(year_born)
   print("if you don't mind once more could you tell me at what year it was when you are planning to have kids, or if you already have kids what year did you have the first one? As just a integer for the year. And if you dont have any kids or arent planning to have kids just input 0 !")
   year_kids_str = input()
   ...
   if choice_2 == "2":
      ...
      if year_kids == 0:
         ...
         kid_age = 2025 - int(year_kids)
         had_kid_age = int(age) - int(kid_age)
      print("so you chose choice two ! Give me a year, and i will tell you how many decedents you will have in that year. Using some approximations of course, having a kid every", had_kid_age, "years and the average family in america has 2 kids so every one of your kids will have two kids and so on. So what year would you like to input?")
